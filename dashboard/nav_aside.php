        ...
        <ul class="navbar-nav">
            ...
            <li class="nav-item">
                <a class="nav-link  " href="../pages/tables.html">
                    ...
                    <span class="nav-link-text ms-1">KPI's</span>
                </a>
            </li>
            <li class="nav-item">
                <a class="nav-link  " href="../pages/tables.html">
                    <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                        <i class="bi bi-person-square text-dark fs-6"></i>
                    </div>
            ...
            <li class="nav-item">
                <a class="nav-link  " href="../pages/billing.html">
                    <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                        <i class="bi bi-currency-bitcoin text-dark fs-6"></i>
                    </div>
            ...
            <li class="nav-item">
                <a class="nav-link  " href="../pages/tables.html">
                    <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                        <i class="bi bi-book text-dark fs-6"></i>
                    </div>
                    <span class="nav-link-text ms-1">งานวิจัย/บทความ</span>
                </a>
            </li>
            <li class="nav-item">
                <a class="nav-link  " href="../pages/virtual-reality.html">
                    ...
                    <span class="nav-link-text ms-1">กิจกรรมคณะ</span>
                </a>
            </li>
            <li class="nav-item">
                <a class="nav-link  " href="../pages/tables.html">
                    ...
                    <span class="nav-link-text ms-1">นักศึกษา</span>
                </a>
            </li>
            <li class="nav-item">
                <a class="nav-link  " href="../pages/virtual-reality.html">
                    ...
                    <span class="nav-link-text ms-1">กิจกรรม น.ศ.</span>
                </a>
            </li>
